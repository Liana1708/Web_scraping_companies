...
This scraper imports a list with the names of more than 1000 companies. Using Selenium the loop iterates through each one of the company names, and it automates the following tasks: 
